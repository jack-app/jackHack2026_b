...
export default function TitleMenu({
  ...
  return (
    <div className="flex flex-col items-center justify-center border border-white-25 bg-[#0d1220] p-10 w-full max-w-xl gap-4">
      <div
        className="text-5xl text-[oklch(90.1%_0.058_230.902)]"
        style={{
          textShadow:
            "0 0 10px rgba(100,200,255,0.8), 0 0 30px rgba(100,200,255,0.5)",
        }}
      >
        SWITCH GAME
      </div>
      ...
      <div className="relative w-full">
        ...
        <span
          ...
          style={{
            color: "rgb(239,68,68)",
            textShadow:
              "0 0 6px rgba(239,68,68,1), 0 0 12px rgba(239,68,68,0.8)",
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              "0 0 8px rgba(239,68,68,0.8), inset 0 0 8px rgba(239,68,68,0.8)",
          }}
        >
          CREATE ROOM
        </button>
      ...
      <div className="relative w-full">
        ...
        <span
          ...
          style={{
            ...
            textShadow:
              "0 0 6px rgba(59,130,246,1), 0 0 12px rgba(59,130,246,0.8)",
            transform: "translate(2px, -6px)",
          }}
        >
          ✦
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              "0 0 8px rgba(59,130,246,0.8), inset 0 0 8px rgba(59,130,246,0.8)",
          }}
        >
          JOIN ROOM
        </button>
      ...
      <div className="text-2xl text-[oklch(98.8% 0.003 106.5)]">
        ...
        <input
          ...
          style={{
            ...
            boxShadow:
              "0 0 8px rgba(255,255,255,0.4), inset 0 0 8px rgba(255,255,255,0.4)",
          }}
        />
      </div>
    </div>
