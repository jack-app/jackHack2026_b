...
// 壁
  ...
  // スイッチ赤
  if (switchState==="red") return (
    <div className="relative w-10 h-10 bg-red-700 drop-shadow-[0_0_10px_rgba(231,0,11,0.8)] text-2xl">
      
      <div className="absolute w-14 rotate-45 border-t border-red-500 origin-left"> 
      </div>
      <div className="absolute w-14 -rotate-45 border-b border-red-500 origin-top-left top-10"> 
      </div>
  ...
  // スイッチ青
  if (switchState==="blue") return (
    <div className="relative w-10 h-10 bg-blue-700 drop-shadow-[0_0_10px_rgba(21,93,251,0.8)] text-2xl">
      
      <div className="absolute w-14 rotate-45 border-t border-blue-500 origin-left"> 
      </div>
      <div className="absolute w-14 -rotate-45 border-b border-blue-500 origin-top-left top-10"> 
      </div>
  ...
  if (switchState===null) return (
    <div className="relative w-10 h-10 bg-stone-400 drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] text-2xl">
      ...
      <div className="absolute w-14 rotate-45 border-t border-stone-200 origin-left"> 
      </div>
      <div className="absolute w-14 -rotate-45 border-b border-stone-200 origin-top-left top-10"> 
      </div>
      <div className="absolute top-1 left-1 flex items-center justify-center bg-stone-200 w-8 h-8 text-blue-300">
